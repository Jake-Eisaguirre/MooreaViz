...
This is the code for the Spatial Tab on the Moorea Shiny App. Each chuck has a sentence above it that explains what that chuck does. There are also commented out explainatains next to the code, within the chunks.  
...
bathy_raster_filtered <- raster(crs = crs, vals = 0, resolution = c(5, 5), ext = extent(bathy_sf_filtered)) %>% 
