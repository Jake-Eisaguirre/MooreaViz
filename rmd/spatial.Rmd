...
spatial_brick <- brick(jan_ras, may_ras, july_ras, jan_ras_i, may_ras_i, july_ras_i, bleach_raster, sewage_ras)

writeRaster(spatial_brick, here("data", "spatial_brick.nc"), format = "CDF")
