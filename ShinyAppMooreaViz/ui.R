                        ...
                        tabPanel(title = "Map",
                                 ...
                                 sidebarPanel(width = 2,
                                              ...
                                              pickerInput(inputId = "Month",
                                                          ...
                                                          selected = "",
                                                          multiple = F,
                                                          options = pickerOptions(title = "Select a Month"),
                                                                   width = 150), 
                                              ...
                                              pickerInput(inputId = "Variable",
                                                          ...
                                                          choices = c("Percent Nitrogen", 
                                                                      "Isotopic Nitrogen"),
                                                          options = pickerOptions(title = "Select a Variables"),
                                                          width = 150), 
                                              ...
                                              pickerInput(inputId = "Additional",
                                                          ...
                                                          selected = NULL,
                                                          multiple = F,
                                                          options = pickerOptions(title = "Select a Additonal"),
                                                                   width = 150),
                                              pickerInput(inputId = "Other",
                                                          ...
                                                          selected = NULL,
                                                          multiple = T,
                                                          options = pickerOptions(title = "Select a Add On"),
                                                          width = 150),                                                 
